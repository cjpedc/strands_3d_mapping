...
int main(int argc, char **argv){
    ...
    int nr_iter = 100;								//Number of iterations the matcher will run
    float shrinking = 0.9;							//The rate of convergence for the matcher
    float bow_threshold = 0.5;						//Bag of words threshold to avoid investigating bad matches
