...
if(NOT "include;/usr/include/opencv;/usr/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/vtk-5.8" STREQUAL "")
  set(ekz_public_lib_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/opencv;/usr/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/vtk-5.8")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'ekz_public_lib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Johan Ekekrantz <ekz@kth.se>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/tmrcv1/catkin_ws/devel/lib;/opt/ros/indigo/lib)
